...
\begin{proof}
  ...
  aber $|e^f|$ nach dem Maximumsprinzip\todo{Referenz} für holomorphe Funktionen
...
\begin{proof}
  ...
  Aus dem Maximumsprinzip\todo{Referenz} für holomorphe Funktionen folgt dann die
...
\begin{cor}
  ...
  Zusammenhangskomponente von $Y$ regulären Rand\todo{Zshkomp. offen}.
\end{cor}
