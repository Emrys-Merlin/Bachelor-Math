...
\begin{bsp}
  ...
  \item Eine weitere Distribution stellt die \init{Dirac Delta
      Distribution} dar. Sie ist durch $\delta_a[f] := f(a)$ für $f
    \in \dist(X)$ und $a \in X$ definiert. \\
    % TODO: Genauer oder weglassen?
...
% TODO: Vielleicht auf Konvergenzeigenschaften der Glättung eingehen?
